...
public:
    ...
    static ChefBindingHandler & GetInstance()
    {
        static ChefBindingHandler sBindingHandler;
...
private:
    ...
    static void BoundDeviceChangedHandler(const EmberBindingTableEntry &, chip::OperationalDeviceProxy *, void *);
